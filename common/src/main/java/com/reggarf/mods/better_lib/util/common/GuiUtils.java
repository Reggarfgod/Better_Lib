...
public class GuiUtils {
    ...
    public static void drawDimBackground(GuiGraphicsExtractor gfx, int w, int h) {
        gfx.fillGradient(0, 0, w, h, 0xAA000000, 0xDD000000);
    }

    public static void drawPanel(GuiGraphicsExtractor gfx, int x1, int y1, int x2, int y2) {
        gfx.fillGradient(x1, y1, x2, y2, 0x99222222, 0xDD000000);
        // drawBorder(gfx, x1, y1, x2, y2);
    }

    public static void drawBorder(GuiGraphicsExtractor gfx, int x1, int y1, int x2, int y2) {
    ...
    public static void drawHeader(GuiGraphicsExtractor gfx, int x1, int x2, int y, String title) {
        ...
        // Left: Back
        gfx.text(font, "< Back", x1 + 10, y + 9, 0xFFFFFF);

        // Right: Close
        gfx.text(font, "X", x2 - 20, y + 9, 0xFF4444);

        // Center title
        gfx.centeredText(font, Component.literal(title), center, y + 9, 0xFFFFFF);
    }
