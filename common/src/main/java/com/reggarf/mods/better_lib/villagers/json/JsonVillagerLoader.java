...
//            throw new IllegalArgumentException("JsonVillagerLoader: no .json files found in '" + folderPath + "'");
//        }
//
...
//        }
    ...
    private static <T> T resolve(Registry<T> registry, String id, String kind, String professionName) {
        ...
        return registry.getOptional(location).orElseThrow(() -> new IllegalArgumentException(
